...
var albumInsert = document.querySelector('#insert2');
...
function toggleTitleStyle(titleIndex) {
    if (titleIndex === 5) {
        titleArray[titleIndex] = titleArray[titleIndex].replace(" class='blooditem claw'", '');
        titleArray[titleIndex] = titleArray[titleIndex].replace('<li>', '<li>' + urlArray[titleIndex]);
        populateTitleList();
    }
    else {
        titleArray[titleIndex] = titleArray[titleIndex].replace(" class='blooditem'", '');
        titleArray[titleIndex] = titleArray[titleIndex].replace('<li>', '<li>' + urlArray[titleIndex]);
...
function checkInput() {
    var textInputValue = document.querySelector('#textinput')
        .value;
    ...
    if (window.localStorage.getItem('the ever infinite nothing') &&
